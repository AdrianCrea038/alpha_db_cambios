// js/ui/menu-lateral.js - VERSIÓN FIJA (NO COLAPSABLE) - SOLO ICONOS CON TEXTO ABAJO
                ...
                <div class="menu-botones">
                    <button id="btnBaseDatos" class="menu-btn active">
                        <span class="menu-icon">
                            <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" width="22" height="22">
    ...
    mostrarMensajeProximamente: function(titulo) {
        ...
        const panelHTML = `
            <div id="proximamentePanel" class="consultas-panel" style="display:block; text-align:center; padding:3rem;">
                ...
                <h3 style="color:#ff3333; margin-bottom:1rem;">${titulo}</h3>
                <p style="color:rgba(224,224,224,0.7); margin-bottom:1rem;">Esta sección está en desarrollo</p>
                <p style="color:#ff4444; font-size:0.8rem;">Próximamente disponible</p>
            </div>
        `;
